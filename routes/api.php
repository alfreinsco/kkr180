...
use App\Http\Controllers\Api\ScanCheckInController;
use App\Http\Controllers\Api\SponsorLogoController;
...
Route::get('/sponsor-logos', [SponsorLogoController::class, 'index']);
Route::post('/ingatkan-saya', [IngatkanSayaController::class, 'store']);
Route::post('/scan/check-in', [ScanCheckInController::class, 'store']);
